...
{
    "dependencies": {
        "com.candycoded.candycoded": "https://github.com/CandyCoded/CandyCoded.git#v1.1.7"
    }
}
```
...
-   [Unity Editor Extensions](Documentation/5.%20Unity%20Editor%20Extensions/)
    ...
    -   [RangeSliderDrawer](Documentation/5.%20Unity%20Editor%20Extensions/RangeSliderDrawer.md)
